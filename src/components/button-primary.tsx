...
export default function ButtonPrimary({text, className}: {text: string, className?: string}) {
  return (
    <Button className={cn('group relative inline-flex items-center justify-center overflow-hidden rounded-full shadow-lg shadow-primary/20    duration-500', className)}>
