...
export default function SectionImage({className}: {className: string}) {
  return (
    <section className={cn('h-[80vh] w-screen relative flex justify-center items-center',className)}>
        ...
        <div className="relative w-full md:px-0  md:max-w-3xl">
            <div className="container flex flex-col space-y-4 items-center justify-center h-full">
                <h2 className=" text-white text-5xl font-bold">Titulo</h2>
                <p className="text-white/80 text-center text-2xl">Descubre una educación de alta calidad que combina estándares académicos rigurosos con métodos innovadores para desarrollar la creatividad y el pensamiento crítico.</p>
